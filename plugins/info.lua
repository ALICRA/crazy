...
local function callback_reply(extra, success, result)
	...
	elseif tonumber(result.from.peer_id) == tonumber(our_id) then
		userrank = "Umbrella-Cp ⭐️⭐️⭐️⭐️⭐️⭐️"
...
if msg.from.phone then
	...
	tt = '----'
                        ...
                        if res ~= 200 then return "No connection" end
                        local jdat = json:decode(url)
			local info = "🌐 ﭑسُمہﮏ ﭑلﮏﭑمہل : "..string.gsub(msg.from.print_name, "_", " ").."\n\n"
					.."♈️ ﭑسُمہﮏ ﭑلﭑوُل : "..(msg.from.first_name or "-----").."\n\n"
					.."♏️ ﭑسُمہﮏ ﭑلثِﭑنہيّ : "..(msg.from.last_name or "-----").."\n\n"
					.."👁 مہعًرُفَﮏ : @"..(msg.from.username or "-----").."\n\n"
					.."🆔 ﭑيّدٍيّﮏ : "..msg.from.id.."\n\n"
                                        .."📞 رُقًمہ هہﭑِِتًفَﮏ : +"..(msg.from.phone or "-----").."\n\n"
										.."🔖 سُيّمہ ﮏرُِِتًﮏ :  "..op.."\n\n"
										.."⚫️ مہنہطًقًِِتًﮏ  :  "..tt.."\n\n"
									    .."📨 ﭑلرُسُﭑلة ﭑلمہرُسُلة :  "..msg.text.."\n\n"	
                                        .."⏱ ﭑلوُقًِِتً :  "..jdat.ENtime.."\n\n"
                                        .."📅 ﭑلِِتًﭑرُيّخُ ـ :  "..jdat.ENdate.."\n\n"
				 	.."👮 رُِِتًبِِِتًﮏ : "..usertype.."\n\n"
	      				.."ﭑلرُسُﭑلة مہنہ 👮 : "..userrank.."\n\n"
					.."📡 ﭑِِتًصَﭑلﮏ مہنہ : "..hardware.."\n\n"
					.."📤 عًدٍدٍ رُسُﭑئلﮏ ﭑلمہرُسُلة : "..user_info.msgs.."\n\n"
					.."♉️ ﭑسُمہ ﭑلﮏرُوُبِ : "..string.gsub(msg.to.print_name, "_", " ").."\n\n"
					.."🆔 ﭑيّدٍيّ ﭑلﮏرُوُبِ : "..msg.to.id.."\n\n"
                                        .."🔸 رُﭑبِطً ـحّسُﭑبِﮏ: telegram.me/"..(msg.from.username or "-----").."\n\n"
                                        .."☢ ﭑيّدٍيّ ﭑلرُسُﭑلة :  "..msg.id.."\n\n"
			return info
		else
